...
const Header = () => {
  // You might want to pass user info or notification count as props later
  return (
    <header className="header bg-white shadow-sm p-5">
      <div className="flex justify-between items-center">
        {/* Кнопка "гамбургер" (можно убрать или сделать функциональной) */}
        <button className="p-2 rounded-md hover:bg-gray-100 md:hidden"> {/* Hide on medium screens and up if sidebar is always visible */}
          <svg
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 rounded-full hover:bg-gray-100 text-gray-600 hover:text-gray-900 focus:outline-none relative">
            ...
            {/* Индикатор уведомлений (можно сделать динамическим) */}
          ...
          <div className="flex items-center border-l pl-4 ml-2">
            ...
            {/* <img className="h-8 w-8 rounded-full" src="/path/to/avatar.jpg" alt="User avatar" /> */}
          </div>
        </div>
      </div>
    </header>
